...
import SessionCrd from '../../components/attendance/SessionCrd'
...
function SessionManager() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <Model isOpen={showModal} onClose={() => setShowModal(false)} title="Create Session">
